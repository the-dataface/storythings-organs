...
var chipH = 0,
	...
	dragHeight = parseInt(dragContainer.style('height'), 10),
	dropHeight = parseInt(dropContainer.style('height'), 10),
	footerHeight = parseInt(footerContainer.style('height'), 10);
